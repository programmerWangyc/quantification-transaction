...
import { community, documentation, factFinder, main, NavItem, square } from '../../base/base.config';
...
class Zodiac {
    ...
    constructor(canvas: any, options: any = {}) {
        ...
        if (canvas.tagName !== 'CANVAS') throw new Error('no canvas');
...
export class FourZeroFourComponent implements OnInit {
    ...
    links: NavItem[] = [main, square, community, factFinder, documentation];
