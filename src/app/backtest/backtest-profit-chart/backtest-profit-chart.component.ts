...
import { BacktestChartService, BacktestProfitChart } from '../providers/backtest.chart.service';
...
export class BacktestProfitChartComponent extends BaseComponent {
    data: Observable<BacktestProfitChart[]>;
    ...
    initialModel() {
        this.data = this.chartService.getProfitChartOptions();
