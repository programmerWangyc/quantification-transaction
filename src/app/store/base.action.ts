...
export abstract class ApiAction {
     ...
     *  Used to indicate whether the request generated by this action can be sent to the server separately.
     */
    ...
    /**
     * @method allSeparate
     *  Convenience method to get the value of 'allowSeparateRequest'.
     */
