...
module.exports = {
    ...
    "rules": [
      ...
      },
      {
        "exclude": [
          ...
          path.join(process.cwd(), "src/theme/dark.theme.scss"),
          path.join(process.cwd(), "node_modules/ng-zorro-antd/src/ng-zorro-antd.less")
        ],
        "test": /\.css$/,
        "use": [
          {
  ...
  "plugins": [
    ...
    new AotPlugin({
        "mainPath": "worker.ts",
        "entryModule": "app/backtest/backtest.module#BacktestModule",
        "tsConfigPath": "src/tsconfig.app.json"
    })
  ],
  "node": {
